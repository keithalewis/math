...
traded strikes.
This market data can be used to define a martingale measure for equation $(2)$.
...
have sufficient imagination when it comes to inventing partitions sufficiently 
flexible to capture possible market dynamics.
...
$$
Its vector space dual can be identified with the Banach space
of finitely additive measures on $S$, $ba(S)$.
