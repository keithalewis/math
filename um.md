...
Arbitrage is a trading strategy with $A_{τ_0} > 0$, $A_t \ge 0$ for
...
if and only if there exists a _deflator_, $D_t:\AA_t \rightarrow \left(
0,\infty \right)$, with
$$
...
See [Fixed Income](fi.html) for details on how all such instruments are valued.
...
Models should have knobs that reflect reality.
