...
If you studied Linear Algebra from Gilbert Strang @cite you learned
...
their connection through distributive laws clarify the structure
of vector spaces and linear operators between them.
You will not learn what a determinant is until the last chapter.

I studied from [@Ner1964] when I was  getting a "C" in my first linear algebra course.
When we got to determinants I noped out.  Who ordered those?
